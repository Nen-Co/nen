...
pub fn main() !void {
    ...
    var research_agent = try nen.createAgentFlow(allocator, "Research Agent", "You are a research assistant. Help users find information and answer questions.");
    ...
    var code_agent = try nen.createAgentFlow(allocator, "Code Assistant", "You are a coding assistant. Help users write, review, and debug code.");
    ...
    var writing_agent = try nen.createAgentFlow(allocator, "Creative Writer", "You are a creative writing assistant. Help users craft stories, poems, and content.");
    ...
    var business_agent = try nen.createAgentFlow(allocator, "Business Analyst", "You are a business analyst. Help users analyze data and make business decisions.");
